 ...
 visGroups(groupname = "Table loaded but empty", color = "#EE9572", shape = "circle") %>%
  ...
  if (CDM %in% c("OMOPV5_3")) {
     nodes <- data.frame(id = dat.net$X, 
                     ...
                     group = c(dat.net$status),
                     shadow = F)
 edges <- data.frame(from = c(31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31, #person
                     ...
                     to = c(12,13,15,16,18,19,20,24,26,28,29,30,32,36,37,38,#person
